...
<body>
    ...
    <tr><td><input type="text" id="fnme" placeholder="First name"   name="X_Firstname" onfocusout="fnvalidate()" onclick="funvalidate()"  style="width:190px; height:30px; "   /><%  Html.TextBox("X_Firstname")%>&nbsp;&nbsp;&nbsp;<input  type="text" id="sname" placeholder="Surname" name="X_Surname" onfocusout="Snvalidate()" onclick="Sunvalidate()" style="width:190px; height:30px;"/><%  Html.TextBox("x_Surname")%>
            ...
            <tr> <td>
               <input type="text" id="phn" placeholder="email or Phone"  name="X_Email" onfocusout="emvalidate()" onclick="emavalidate()" style="width:290px; height:30px;" /><%  Html.TextBox("X_Email")%></td></tr>
               <tr><td><input type="text" id="pn" placeholder="Re_enter email or mobail" onfocusout="xmaivalidate()" onclick="ymilvalidate()" style="width:290px; height:30px;"></td></tr>
               
                    <tr><td>
                       <input type="password" id="psw" placeholder="password" name="X_supPassword" onfocusout ="psvalidate()" onclick="pswvalidate()"  style ="width:290px; height:30px;" /><%  Html.TextBox("X_Password") %></td></tr>
                       
                     <tr><td><input type="text" style="width:318px; height:30px;  " /><input type="file"name="X_propic" accept="image/png"  style="background-color: Green;"/><%  Html.TextBox("X_propic")%>
